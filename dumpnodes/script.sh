#!/bin/bash -e
AVGCOLOR_PATH=/home/filhit/.minetest/mods/dsoulstest_server_modpack/dumpnodes/avgcolors.py
GAME_PATH=/usr/share/minetest/games/minetest_game
MODS_PATH=/home/filhit/.minetest/mods # path to "mods" folder, only set if you have loaded mods
NODESTXT_PATH=/home/filhit/nodes.txt
...
while read -r line; do
	...
	echo "$1" $(python3 $AVGCOLOR_PATH "$tex")
	echo "ok $1" >&2
